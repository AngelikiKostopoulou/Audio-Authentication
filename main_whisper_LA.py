...
# Hyperparameters
    ...
    model_tag = 'model_{}_{}_{}_{}_{}_whispernew'.format(
    ...
    #evaluation 
    if args.eval:
        file_eval = genSpoof_list( dir_meta =  os.path.join(args.database_path,'ASVspoof2021_LA_eval','ASVspoof2021.LA.cm.eval.trl.txt'),is_train=False,is_eval=True)       
