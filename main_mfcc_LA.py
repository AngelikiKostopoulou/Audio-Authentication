...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='/home/a/angelikkd/GitProjects/SSL_Anti-spoofing/database/dataNEW/database_path/', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
...
# Hyperparameters
    ...
    model_tag = 'model_{}_{}_{}_{}_{}_mfcc'.format(
    ...
    if args.eval:
        ...
        file_eval = genSpoof_list( dir_meta =  os.path.join(args.protocols_path,'LA/ASVspoof2021_LA_eval','ASVspoof2021.LA.cm.eval.trl.txt'),is_train=False,is_eval=True)
    ...
    d_label_dev,file_dev = genSpoof_list( dir_meta =  os.path.join(args.protocols_path,'LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.dev.trl.txt'),is_train=False,is_eval=False)
